      ...
      <div className="flex flex-col items-left w-11/12 lg:w-9/12 max-w-[1200px]">
        ...
        <div
          ...
          <div className="col-span-4 m-5 flex flex-col items-center w-9/12 self-center">
            ...
            <div className="mt-2">
              <p>
                Dive into the world of professional portraiture at our workshop!
                Learn how to master lighting setups and backdrop selections to
                dramatically enhance your subject's features and emotions.
              </p>
              <br />
        ...
        <div
          ...
          <div className="col-span-4 m-5 flex flex-col items-center w-9/12 self-center">
            ...
            <div className="mt-2">
              <p>
                Hit the streets with confidence! This workshop will enhance your
                skills in capturing candid moments and engaging quickly with
                subjects, ensuring you never miss a shot.
              </p>
              <br />
