  ...
  return (
    <section id="Timeline" className="flex justify-center">
      <div className="flex flex-col items-left w-9/12 max-w-[1200px] bg-blue-100">
        ...
        <div className="card-container grid grid-cols-1 xl:grid-cols-5">
          <div className="bg-blue-200 col-span-1 flex md:justify-center xl:justify-end items-center mx-10">
